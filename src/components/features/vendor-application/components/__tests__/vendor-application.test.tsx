...
const mockTranslation = {
    t: (key: string) => {
        const translations: { [key: string]: string } = {
            ...
            'vendor.application.companyInfo': 'Company Information',
            ...
            'vendor.application.validation.companyNameRequired': 'Company name is required',
            'vendor.application.validation.companyNameLength': 'Company name must be at least 2 characters',
            'vendor.application.validation.businessRegRequired': 'Business registration number is required',
            'vendor.application.validation.emailRequired': 'Contact email is required',
            'vendor.application.validation.emailInvalid': 'Please enter a valid email address',
            'vendor.application.validation.phoneRequired': 'Contact phone is required',
            'vendor.application.validation.phoneInvalid': 'Please enter a valid phone number',
            'vendor.application.validation.categoryRequired': 'Product category is required',
            'vendor.application.validation.descriptionRequired': 'Business description is required',
            'vendor.application.validation.descriptionLength': 'Business description must be at least 20 characters',
            'vendor.application.validation.logoRequired': 'Company logo is required',
            'vendor.application.validation.logoSize': 'Company logo must be less than 5MB',
            'vendor.application.validation.certificateRequired': 'Business certificate is required',
            'vendor.application.validation.certificateSize': 'Business certificate must be less than 10MB',
        };
...
describe('VendorApplicationPage', () => {
    ...
    beforeEach(() => {
        ...
        (firestoreService as any).submitVendorApplication = mockSubmitVendorApplication;
    ...
    it('displays the main title and subtitle', async () => {
        ...
        await waitFor(() => {
            ...
            expect(screen.getByText('Create and manage your own lottery games to promote your products and engage customers')).toBeInTheDocument();
        });
    });
    ...
    it('shows approved application status', async () => {
        const approvedApplication = { ...mockExistingApplication, status: 'APPROVED' };
        ...
        await waitFor(() => {
            ...
            expect(screen.getByText('Your vendor application has been approved. You can now create and manage games!')).toBeInTheDocument();
        });
    });
