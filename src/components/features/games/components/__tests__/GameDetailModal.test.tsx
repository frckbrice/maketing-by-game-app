...
jest.mock('next/image', () => {
  return ({ src, alt, fill, width, height, className, style, sizes, priority }: any) => (
    <img 
      src={src} 
      alt={alt} 
      width={width} 
...
describe('GameDetailModal', () => {
  ...
  it('renders nothing when not open', () => {
    render(<GameDetailModal game={mockGame} isOpen={false} onClose={mockOnClose} />);
  ...
  it('renders modal with game details when open', () => {
    render(<GameDetailModal game={mockGame} isOpen={true} onClose={mockOnClose} />);
    ...
    // Check description
    expect(screen.getByText('Latest iPhone model with amazing features')).toBeInTheDocument();
  ...
  it('displays fallback icon when no image', () => {
    render(<GameDetailModal game={mockGameWithoutImages} isOpen={true} onClose={mockOnClose} />);
  ...
  it('does not display sponsor section when no sponsor', () => {
    render(<GameDetailModal game={mockGameWithoutSponsor} isOpen={true} onClose={mockOnClose} />);
  ...
  it('closes modal when close button is clicked', () => {
    ...
    const closeButton = document.querySelector('button svg[class*="lucide-x"]')?.closest('button');
  ...
  it('displays correct progress bar color based on progress', () => {
    ...
    const progressBar = document.querySelector('.bg-gradient-to-r.from-orange-500.to-red-500');
  ...
  it('displays hot progress bar when over 75%', () => {
    ...
    render(<GameDetailModal game={hotGame} isOpen={true} onClose={mockOnClose} />);
  ...
  it('displays almost full progress bar when over 90%', () => {
    ...
    render(<GameDetailModal game={almostFullGame} isOpen={true} onClose={mockOnClose} />);
    
    const progressBar = document.querySelector('.bg-gradient-to-r.from-red-500.to-red-600');
    expect(progressBar).toBeInTheDocument();
  });
  ...
  it('displays correct time remaining format', () => {
    ...
    render(<GameDetailModal game={gameWithLongTime} isOpen={true} onClose={mockOnClose} />);
  ...
  it('displays hours only when less than 1 day', () => {
    ...
    render(<GameDetailModal game={gameWithShortTime} isOpen={true} onClose={mockOnClose} />);
  ...
  it('shows new badge for games less than 24 hours old', () => {
    ...
    render(<GameDetailModal game={newGame} isOpen={true} onClose={mockOnClose} />);
  ...
  it('does not show new badge for older games', () => {
    ...
    render(<GameDetailModal game={oldGame} isOpen={true} onClose={mockOnClose} />);
  ...
  it('does not show hot badge for games under 75% full', () => {
    ...
    render(<GameDetailModal game={coldGame} isOpen={true} onClose={mockOnClose} />);
  ...
  it('handles games with missing category gracefully', () => {
    ...
    render(<GameDetailModal game={gameWithoutCategory} isOpen={true} onClose={mockOnClose} />);
  ...
  it('handles games with zero max participants', () => {
    ...
    render(<GameDetailModal game={gameWithZeroMax} isOpen={true} onClose={mockOnClose} />);
  ...
  it('handles games with expired end date', () => {
    ...
    render(<GameDetailModal game={expiredGame} isOpen={true} onClose={mockOnClose} />);
