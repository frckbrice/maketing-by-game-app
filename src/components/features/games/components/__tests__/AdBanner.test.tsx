...
describe('AdBanner', () => {
    ...
    describe('Rendering', () => {
        it('renders with default props', () => {
            ...
            expect(screen.getByText('This is an amazing product that will change your life')).toBeInTheDocument();
    ...
    describe('Image Handling', () => {
        it('renders image when imageUrl is provided', () => {
            render(<AdBanner {...defaultProps} imageUrl="https://example.com/image.jpg" />);
        ...
        it('applies correct image classes for horizontal layout', () => {
            render(<AdBanner {...defaultProps} type="horizontal" imageUrl="https://example.com/image.jpg" />);

            const imageContainer = screen.getByAltText('Amazing Product').parentElement;
            expect(imageContainer).toHaveClass('w-32', 'h-full');
        });

        it('applies correct image classes for vertical layout', () => {
            render(<AdBanner {...defaultProps} type="vertical" imageUrl="https://example.com/image.jpg" />);
        ...
        it('applies correct image classes for square layout', () => {
            render(<AdBanner {...defaultProps} type="square" imageUrl="https://example.com/image.jpg" />);
    ...
    describe('Close Functionality', () => {
        it('renders close button when onClose is provided', () => {
            ...
            const closeButton = screen.getByRole('button', { name: 'Close advertisement' });
        ...
        it('does not render close button when onClose is not provided', () => {
            ...
            const closeButton = screen.queryByRole('button', { name: 'Close advertisement' });
    ...
    describe('Accessibility', () => {
        ...
        it('has correct aria-label', () => {
            ...
            const banner = screen.getByRole('banner');
            expect(banner).toHaveAttribute('aria-label', 'Advertisement: Amazing Product');
        });
    ...
    describe('Hover Effects', () => {
        it('has hover classes for interactive elements', () => {
            ...
            const banner = screen.getByRole('banner');
            expect(banner).toHaveClass('hover:border-blue-300', 'dark:hover:border-blue-700');
        });
        ...
        it('has hover effect for title', () => {
            ...
            expect(title).toHaveClass('group-hover:text-blue-600', 'dark:group-hover:text-blue-400');
        });
...
describe('AdBannerSkeleton', () => {
    ...
    describe('Rendering', () => {
        it('renders skeleton with correct type', () => {
            ...
            const skeleton = document.querySelector('.bg-gray-100.dark\\:bg-gray-800.rounded-2xl.animate-pulse');
    ...
    describe('Skeleton Elements', () => {
        ...
        it('applies correct image classes for horizontal layout', () => {
            ...
            const imagePlaceholder = document.querySelector('.bg-gray-200.dark\\:bg-gray-700.flex-shrink-0');
