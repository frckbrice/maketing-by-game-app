...
export const VendorBanner = React.memo<VendorBannerProps>(function VendorBanner({
  banners = [],
  onBannerClick,
  className = '',
}) {
  ...
  if (!mounted || banners.length === 0) {
    return (
      <div className={`relative h-32 sm:h-40 lg:h-48 bg-gradient-to-r from-orange-100 to-red-100 dark:from-orange-900/20 dark:to-red-900/20 rounded-2xl overflow-hidden animate-pulse ${className}`}>
