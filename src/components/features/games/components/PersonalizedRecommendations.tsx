...
export const PersonalizedRecommendations =
  React.memo<PersonalizedRecommendationsProps>(
        ...
        <div className={`mb-16 ${className}`}>
          ...
          <div className='flex items-center justify-between mb-8'>
            <div className='flex items-center'>
              ...
              <div>
                <h2 className='text-3xl font-bold text-gray-900 dark:text-white'>
                  {t('marketplace.personalized.productsYouMightLike')}
                </h2>
                <p className='text-gray-600 dark:text-gray-400'>
                  {t('marketplace.personalized.personalizedRecommendations')}
                </p>
              </div>
            </div>
            ...
            <div className='flex items-center text-pink-600 dark:text-pink-400'>
              ...
              <span className='text-sm font-medium'>
                {t('marketplace.personalized.basedOnYourLikes')}
              </span>
            </div>
          </div>
          ...
          <div className='mt-8 text-center'>
            <p className='text-sm text-gray-500 dark:text-gray-400 max-w-2xl mx-auto'>
              {t('marketplace.personalized.personalizationNote')}
            </p>
          </div>
        </div>
      );
