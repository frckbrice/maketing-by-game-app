  ...
  if (error) {
    return (
      <div className='text-center py-12'>
        ...
        <p className='text-gray-400 mb-6'>{t('orderHistory.error.message')}</p>
        <Button
          ...
          <div className='relative'>
            ...
            >
              ...
              <option value='PENDING'>
                {t('orderHistory.status.pending')}
              </option>
              <option value='PROCESSING'>
                {t('orderHistory.status.processing')}
              </option>
              <option value='SHIPPED'>
                {t('orderHistory.status.shipped')}
              </option>
          ...
          <div className='relative'>
            ...
            >
              ...
              <option value='amount_high'>
                {t('orderHistory.sort.amountHigh')}
              </option>
              <option value='amount_low'>
                {t('orderHistory.sort.amountLow')}
              </option>
            </select>
          </div>
