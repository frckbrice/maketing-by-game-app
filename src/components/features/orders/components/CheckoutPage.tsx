...
const CheckoutPage = React.memo<CheckoutPageProps>(
  ({ items, shopId, shopName, onBack }) => {
    ...
    const [selectedPaymentMethod, setSelectedPaymentMethod] = useState<
      'MOBILE_MONEY' | 'CREDIT_CARD' | 'PAYPAL'
    >('MOBILE_MONEY');
    ...
    const selectedDeliveryMethodData = deliveryMethods.find(
      dm => dm.id === selectedDeliveryMethod
    );
