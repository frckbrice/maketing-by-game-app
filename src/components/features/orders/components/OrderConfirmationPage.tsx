            ...
            <div className='space-y-6'>
                ...
                <div className='mt-4 pt-4 border-t border-gray-700'>
                  <div className='space-y-2 text-sm'>
                    ...
                    <div className='flex justify-between text-gray-300'>
                      ...
                      <span>
                        {displayOrder.tax.toLocaleString()}{' '}
                        {displayOrder.currency}
                      </span>
                    </div>
              ...
              <div className='bg-gray-800 rounded-lg p-6'>
                ...
                <div className='flex items-center space-x-3 p-3 bg-gray-700 rounded-lg'>
                  <div
                    className={`w-3 h-3 rounded-full ${displayOrder.status === 'PENDING' ? 'bg-yellow-400' : 'bg-gray-500'}`}
                  ></div>
                  <div className='flex-1'>
                    <p
                      className={`font-medium ${getStatusColor(displayOrder.status)}`}
                    >
                      {t(
                        `orderConfirmation.status.${displayOrder.status.toLowerCase()}`
                      )}
                    </p>
                  ...
                  {displayOrder.deliveryAddress && (
                    <div className='p-3 bg-gray-700 rounded-lg'>
                      ...
                      <p className='text-gray-300 text-sm'>
                        ...
                        {displayOrder.deliveryAddress.postalCode}
                      </p>
                      <p className='text-gray-400 text-sm'>
                  ...
                  <div className='flex items-center justify-between'>
                    <div className='flex items-center'>
                      ...
                      <div>
                        <p className='text-white font-medium'>
                          {t(
                            `checkout.${displayOrder.paymentMethod.toLowerCase().replace('_', '')}`
                          )}
                        </p>
                        <p
                          className={`text-sm ${
                        ...
                        >
                          {t(
                            `orderConfirmation.paymentStatus.${displayOrder.paymentStatus.toLowerCase()}`
                          )}
                        </p>
                      </div>
                    </div>
