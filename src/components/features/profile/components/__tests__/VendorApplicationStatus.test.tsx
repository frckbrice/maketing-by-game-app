...
describe('VendorApplicationStatus', () => {
    ...
    describe('Rendering', () => {
        it('renders the component with correct title', () => {
            ...
            expect(screen.getByText("You haven't applied to become a vendor yet.")).toBeInTheDocument();
        });
        ...
        it('displays building icon in header', () => {
            ...
            const buildingIcon = document.querySelector('svg[class*="lucide-building-2"]');
    ...
    describe('Loading State', () => {
        it('shows loading skeleton when checking application status', () => {
            ...
            mockGetVendorApplication.mockImplementation(() => new Promise(resolve => setTimeout(resolve, 100)));
    ...
    describe('Pending Application State', () => {
        it('shows pending status with correct icon and badge', async () => {
            ...
            await waitFor(() => {
                ...
                expect(screen.getByText('Your application is currently under review. We\'ll notify you once a decision has been made.')).toBeInTheDocument();
            });
        });
        ...
        it('displays pending status icon correctly', async () => {
            ...
            await waitFor(() => {
                const pendingIcon = document.querySelector('svg[class*="lucide-clock"]');
        ...
        it('applies correct CSS classes for pending status', async () => {
            ...
            await waitFor(() => {
                ...
                const pendingMessage = screen.getByText('Your application is currently under review. We\'ll notify you once a decision has been made.');
                expect(pendingMessage.closest('div')).toHaveClass('bg-yellow-50', 'dark:bg-yellow-900/20', 'border-yellow-200', 'dark:border-yellow-800');
            });
        });
    });
    ...
    describe('Approved Application State', () => {
        it('shows approved status with correct icon and badge', async () => {
            ...
            await waitFor(() => {
                ...
                expect(screen.getByText('🎉 Congratulations! Your vendor application has been approved. You can now create and manage lottery games.')).toBeInTheDocument();
            });
        });
        ...
        it('displays approved status icon correctly', async () => {
            ...
            await waitFor(() => {
                const approvedIcon = document.querySelector('svg[class*="lucide-check-circle"]');
        ...
        it('shows access vendor dashboard button', async () => {
            ...
            await waitFor(() => {
                const dashboardButton = screen.getByRole('button', { name: /access vendor dashboard/i });
                expect(dashboardButton).toBeInTheDocument();
                expect(dashboardButton).toHaveClass('bg-green-500', 'hover:bg-green-600');
            });
        });
        ...
        it('applies correct CSS classes for approved status', async () => {
            ...
            await waitFor(() => {
                ...
                const approvedMessage = screen.getByText('🎉 Congratulations! Your vendor application has been approved. You can now create and manage lottery games.');
                expect(approvedMessage.closest('div')).toHaveClass('bg-green-50', 'dark:bg-green-900/20', 'border-green-200', 'dark:border-green-800');
            });
        });
    });
    ...
    describe('Rejected Application State', () => {
        it('shows rejected status with correct icon and badge', async () => {
            ...
            await waitFor(() => {
                ...
                expect(screen.getByText('Your vendor application was not approved at this time.')).toBeInTheDocument();
                expect(screen.getByText('Reason: Insufficient documentation')).toBeInTheDocument();
            });
        });
        ...
        it('displays rejected status icon correctly', async () => {
            ...
            await waitFor(() => {
                const rejectedIcon = document.querySelector('svg[class*="lucide-x-circle"]');
        ...
        it('applies correct CSS classes for rejected status', async () => {
            ...
            await waitFor(() => {
                ...
                const rejectedMessage = screen.getByText('Your vendor application was not approved at this time.');
                expect(rejectedMessage.closest('div')).toHaveClass('bg-red-50', 'dark:bg-red-900/20', 'border-red-200', 'dark:border-red-800');
            });
        });
    ...
    describe('Status Updates and Notifications', () => {
        it('shows success toast when application is approved', async () => {
            ...
            await waitFor(() => {
                expect(require('sonner').toast.success).toHaveBeenCalledWith('🎉 Your vendor application has been approved!');
            });
        });
        ...
        it('shows error toast when application is rejected', async () => {
            ...
            await waitFor(() => {
                expect(require('sonner').toast.error).toHaveBeenCalledWith('Your vendor application was rejected. Check details below.');
            });
        });
    ...
    describe('Styling and Layout', () => {
        it('applies correct container styling', async () => {
            ...
            await waitFor(() => {
                const container = document.querySelector('.bg-white.dark\\:bg-gray-800.rounded-lg.shadow-md.p-6.border.border-gray-200.dark\\:border-gray-700');
        ...
        it('applies correct button styling', async () => {
            ...
            await waitFor(() => {
                const applyButton = screen.getByRole('button', { name: /apply now/i });
                expect(applyButton).toHaveClass('bg-blue-500', 'hover:bg-blue-600', 'text-white', 'py-2', 'px-4', 'rounded-md', 'transition-colors');
            });
        });
    });
