...
export const LoyaltyPointsDisplay: React.FC = () => {
  ...
  if (!loyaltyProfile) {
    return (
      <Card>
        <CardContent className="p-6">
          <p className="text-gray-500 dark:text-gray-400">No loyalty profile found</p>
        </CardContent>
      </Card>
    );
  }

  const levelProgress = loyaltyProfile.nextLevelThreshold > loyaltyProfile.totalPointsEarned 
    ? ((loyaltyProfile.totalPointsEarned - (loyaltyProfile.level === 1 ? 0 : 1000)) / 
       (loyaltyProfile.nextLevelThreshold - (loyaltyProfile.level === 1 ? 0 : 1000))) * 100
    : 100;
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center text-sm">
              <div className="text-center">
                <div className="font-semibold">{loyaltyProfile.totalPointsEarned.toLocaleString()}</div>
                <div className="text-orange-100">Total Earned</div>
              </div>
              <div className="text-center">
                <div className="font-semibold">{loyaltyProfile.totalPointsSpent.toLocaleString()}</div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium">
                  {loyaltyProfile.totalPointsEarned} / {loyaltyProfile.nextLevelThreshold}
                </span>
              </div>
              <Progress 
            ...
            {loyaltyProfile.nextLevelThreshold > loyaltyProfile.totalPointsEarned && (
              <p className="text-sm text-gray-600 dark:text-gray-400">
                {(loyaltyProfile.nextLevelThreshold - loyaltyProfile.totalPointsEarned).toLocaleString()} 
          ...
          <CardContent className="p-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold">{loyaltyProfile.lifetimeGamesPlayed}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold">{loyaltyProfile.consecutiveDaysStreak} days</p>
              </div>
            </div>
          </CardContent>
        </Card>
