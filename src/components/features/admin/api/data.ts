...
export const ADMIN_PERMISSIONS = [
  ...
  },
  {
    ...
    description: 'Create and manage lottery games',
  },
  {
    id: 'VENDORS',
    label: 'Vendor Management',
    description: 'Manage vendor applications and accounts',
  },
  {
    id: 'ANALYTICS',
    label: 'Analytics',
...
export const DEFAULT_PERMISSIONS: Permission[] = [
  ...
  // Game Management
  {
    id: 'games.read',
    name: 'View Games',
    description: 'View game details and lists',
    category: 'Game Management',
  },
  {
    id: 'games.create',
    name: 'Create Games',
    description: 'Create new lottery games',
    category: 'Game Management',
  },
  {
    id: 'games.update',
    name: 'Update Games',
    description: 'Edit game settings and details',
    category: 'Game Management',
  },
  {
    id: 'games.delete',
    name: 'Delete Games',
    description: 'Delete or archive games',
    category: 'Game Management',
  },
  {
    id: 'games.publish',
    name: 'Publish Games',
    description: 'Publish games and make them active',
    category: 'Game Management',
  },
  {
    id: 'games.moderate',
    name: 'Moderate Games',
    description: 'Approve or reject vendor games',
    category: 'Game Management',
  },
  ...
  },
  {
    ...
    description: 'Issue refunds and adjustments',
    category: 'Financial',
  },
  {
  ...
  // Content Management
  {
    ...
    description: 'Create and edit game categories',
    category: 'Content Management',
  },
  {
    id: 'winners.manage',
    name: 'Manage Winners',
    description: 'Manage winner announcements',
    category: 'Content Management',
  },
  {
