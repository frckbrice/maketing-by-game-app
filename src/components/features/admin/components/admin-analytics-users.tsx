...
const mockBehaviorData: UserBehaviorData[] = [
    { date: '2025-01-01', newUsers: 45, activeUsers: 320, gameParticipants: 180, conversionRate: 56.25, avgSessionDuration: 12.5 },
    { date: '2025-01-02', newUsers: 52, activeUsers: 340, gameParticipants: 195, conversionRate: 57.35, avgSessionDuration: 13.2 },
    { date: '2025-01-03', newUsers: 38, activeUsers: 385, gameParticipants: 220, conversionRate: 57.14, avgSessionDuration: 14.1 },
    { date: '2025-01-04', newUsers: 41, activeUsers: 362, gameParticipants: 205, conversionRate: 56.63, avgSessionDuration: 13.8 },
    { date: '2025-01-05', newUsers: 47, activeUsers: 398, gameParticipants: 235, conversionRate: 59.05, avgSessionDuration: 15.2 },
    { date: '2025-01-06', newUsers: 55, activeUsers: 420, gameParticipants: 255, conversionRate: 60.71, avgSessionDuration: 16.1 },
    { date: '2025-01-07', newUsers: 49, activeUsers: 435, gameParticipants: 268, conversionRate: 61.61, avgSessionDuration: 16.8 },
];
...
const mockUserSegments: UserSegment[] = [
    { name: 'High Value Players', count: 285, percentage: 17.6, color: '#10B981' },
...
export function AdminAnalyticsUsersPage() {
    ...
    const { data: userAnalytics, isLoading: analyticsLoading } = useUserAnalytics ? useUserAnalytics({
        timeRange,
                    ...
                    <Card className="p-6">
                        ...
                        <div className="mt-4 flex items-center">
                            <span className="text-sm text-gray-600 dark:text-gray-400">
                                {metrics ? formatPercentage((metrics.activeUsers / metrics.totalUsers) * 100) : '0%'} {t('admin.ofTotal')}
                            </span>
                        </div>
                    </Card>
