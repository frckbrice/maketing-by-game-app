...
export function AdminAnalyticsPage() {
  ...
  const fetchAnalytics = useCallback(async () => {
    try {
      ...
      // In production, this would call actual analytics API
      const mockData: AnalyticsData = {
        ...
        usersByDay: Array.from({ length: 30 }, (_, i) => ({
          date: new Date(Date.now() - (29 - i) * 24 * 60 * 60 * 1000)
            .toISOString()
            .split('T')[0],
        ...
        categoryPerformance: [
          { name: 'Tech & Phones', revenue: 15600, games: 23, users: 1240 },
          { name: 'Fashion & Sneakers', revenue: 12300, games: 18, users: 980 },
          { name: 'Home Appliances', revenue: 9800, games: 15, users: 750 },
          { name: 'Computers', revenue: 7900, games: 12, users: 620 },
        ],
        gamePerformance: Array.from({ length: 10 }, (_, i) => ({
          title: `Game ${i + 1}`,
        ...
        deviceStats: [
          { device: 'Mobile', percentage: 65, users: 1878 },
          { device: 'Desktop', percentage: 25, users: 723 },
          { device: 'Tablet', percentage: 10, users: 289 },
        ],
      };
