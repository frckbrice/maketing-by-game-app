...
describe('AdminSettingsPage', () => {
  ...
  beforeEach(() => {
    ...
    mockFirestoreService.getAppSettings = jest
      .fn()
  ...
  describe('Settings Display', () => {
    ...
    it('displays current settings values', async () => {
      ...
      expect(
        screen.getByDisplayValue('Win amazing prizes with our lottery games')
      ).toBeInTheDocument();
      expect(
        screen.getByDisplayValue('support@lotteryapp.com')
      ).toBeInTheDocument();
  ...
  describe('Form Interactions', () => {
    ...
    it('updates app description when textarea changes', async () => {
      ...
      await waitFor(() => {
        const appDescriptionTextarea = screen.getByDisplayValue(
          'Win amazing prizes with our lottery games'
        );
        fireEvent.change(appDescriptionTextarea, {
  ...
  describe('Switch Interactions', () => {
    ...
    it('toggles push notifications', async () => {
      ...
      await waitFor(() => {
        const pushNotificationsSwitch = screen.getByLabelText(
