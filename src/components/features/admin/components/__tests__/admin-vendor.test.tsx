...
describe('AdminVendorApplicationsPage', () => {
  ...
  beforeEach(() => {
    ...
    mockFirestoreService.getAllVendorApplications = jest
      .fn()
      .mockResolvedValue(mockApplications);
    mockFirestoreService.approveVendorApplication = jest
      .fn()
      .mockResolvedValue(undefined);
    mockFirestoreService.rejectVendorApplication = jest
      .fn()
      .mockResolvedValue(undefined);
    mockNotificationService.sendVendorApplicationNotification = jest
      .fn()
      .mockResolvedValue(undefined);
  ...
  describe('Data Loading', () => {
    it('loads vendor applications from firestore service', async () => {
      ...
      await waitFor(() => {
        expect(
          mockFirestoreService.getAllVendorApplications
        ).toHaveBeenCalled();
      });
    });
  ...
  describe('Application Information Display', () => {
    ...
    it('displays contact information', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText('contact@techsolutions.com')
        ).toBeInTheDocument();
  ...
  describe('Application Approval', () => {
    it('handles application approval', async () => {
      ...
      await waitFor(() => {
        expect(
          mockFirestoreService.approveVendorApplication
