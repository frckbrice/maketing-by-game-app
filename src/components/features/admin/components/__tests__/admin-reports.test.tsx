...
describe('AdminReportsPage', () => {
    ...
    describe('Report List Display', () => {
        it('displays all reports correctly', async () => {
            ...
            await waitFor(() => {
                expect(screen.getAllByText('Financial Summary - Q4 2024')).toHaveLength(2); // Desktop and mobile
                expect(screen.getAllByText('User Activity Report')).toHaveLength(2); // Desktop and mobile
                expect(screen.getAllByText('Game Performance Analysis')).toHaveLength(2); // Desktop and mobile
            });
        });
        ...
        it('displays report information correctly', async () => {
            ...
            await waitFor(() => {
                expect(screen.getAllByText('Quarterly financial overview')).toHaveLength(2); // Desktop and mobile
                expect(screen.getAllByText('Monthly user engagement metrics')).toHaveLength(2); // Desktop and mobile
                expect(screen.getAllByText('Top performing games analysis')).toHaveLength(2); // Desktop and mobile
            });
        });
