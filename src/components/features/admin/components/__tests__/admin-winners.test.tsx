...
describe('AdminWinnersPage', () => {
    ...
    beforeEach(() => {
        ...
        mockCurrencyService.formatCurrency = jest.fn((value, currency) => `$${value.toLocaleString()}`);
        mockFirestoreService.getAllWinners = jest.fn().mockResolvedValue(mockWinners);
    });
