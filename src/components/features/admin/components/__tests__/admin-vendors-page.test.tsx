...
const mockUseVendors = require('@/hooks/useApi')
  .useVendors as jest.MockedFunction<any>;
const mockUseUpdateUserStatus = require('@/hooks/useApi')
  .useUpdateUserStatus as jest.MockedFunction<any>;
...
describe('AdminVendorsPage', () => {
  ...
  describe('Data Loading', () => {
    ...
    it('displays vendor information correctly', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getAllByText('john.doe@example.com')[0]
        ).toBeInTheDocument();
        expect(
          screen.getAllByText('Tech Solutions Inc')[0]
        ).toBeInTheDocument();
  ...
  describe('Error Handling', () => {
    it('handles service errors gracefully', async () => {
      mockAdminService.updateUserStatus = jest
        .fn()
