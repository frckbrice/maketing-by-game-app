    ...
    useTranslation: () => ({
        t: (key: string, fallback?: string) => {
            const translations: Record<string, string> = {
                ...
                'admin.trackUserEngagementAndBehavior': 'Track user engagement and behavior',
...
const mockUseUserAnalytics = require('@/hooks/useApi').useUserAnalytics as jest.MockedFunction<any>;
...
const mockBehaviorData = [
    { date: '2024-01-01', newUsers: 45, activeUsers: 320, gameParticipants: 180, conversionRate: 56.25, avgSessionDuration: 12.5 },
    { date: '2024-01-02', newUsers: 52, activeUsers: 340, gameParticipants: 195, conversionRate: 57.35, avgSessionDuration: 13.2 },
];
...
describe('AdminAnalyticsUsersPage', () => {
    ...
    describe('Responsive Design', () => {
        it('displays metrics in grid layout', async () => {
            ...
            await waitFor(() => {
                const metricCards = screen.getAllByText(/Total Users|Active Users|Conversion Rate|Avg Session Duration/);
