...
describe('AdminRolesPage', () => {
    ...
    describe('Role Display', () => {
        ...
        it('displays role descriptions correctly', async () => {
            ...
            await waitFor(() => {
                expect(screen.getByText('Standard user with basic permissions')).toBeInTheDocument();
                expect(screen.getByText('Vendor with game creation permissions')).toBeInTheDocument();
