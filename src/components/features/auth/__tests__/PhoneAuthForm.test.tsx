...
describe('PhoneAuthForm', () => {
    ...
    describe('Phone Step', () => {
        ...
        it('handles successful code sending', async () => {
            ...
            await waitFor(() => {
                expect(mockSendPhoneVerificationCode).toHaveBeenCalledWith('15551234567');
        ...
        it('handles code sending error with non-Error object', async () => {
            ...
            await waitFor(() => {
                ...
                expect(defaultProps.onError).toHaveBeenCalledWith(new Error('Failed to send code'));
            });
        });
    });
    ...
    describe('Verification Step', () => {
        ...
        it('transitions to verification step after sending code', async () => {
            ...
            await waitFor(() => {
                expect(screen.getByText(/we've sent a 6-digit code to \+1 \(555\) 123-4567/i)).toBeInTheDocument();
        ...
        it('displays shield icon in verification step', async () => {
            ...
            await waitFor(() => {
                const shieldIcon = document.querySelector('svg[class*="lucide-shield"]');
        ...
        it('handles successful code verification', async () => {
            ...
            await waitFor(() => {
                ...
                expect(mockVerifyPhoneCode).toHaveBeenCalledWith('+1 (555) 123-4567', '123456');
        ...
        it('handles code verification error with non-Error object', async () => {
            ...
            await waitFor(() => {
                ...
                expect(defaultProps.onError).toHaveBeenCalledWith(new Error('Invalid verification code'));
            });
        });
