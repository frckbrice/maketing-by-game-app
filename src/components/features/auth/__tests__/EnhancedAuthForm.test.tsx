...
describe('EnhancedAuthForm', () => {
    ...
    describe('Login Mode', () => {
        ...
        it('toggles password visibility', async () => {
            ...
            const toggleButton = document.querySelector('button[type="button"] svg[class*="lucide-eye"]')?.closest('button');
    ...
    describe('Register Mode', () => {
        ...
        it('handles all form input changes', async () => {
            ...
            const lastNameInput = screen.getByPlaceholderText('Enter your last name (optional)');
            const emailInput = screen.getByPlaceholderText('Enter your email');
            const passwordInput = screen.getByPlaceholderText('Enter your password');
        ...
        it('toggles confirm password visibility', async () => {
            ...
            const toggleButtons = document.querySelectorAll('button[type="button"] svg[class*="lucide-eye"]');
