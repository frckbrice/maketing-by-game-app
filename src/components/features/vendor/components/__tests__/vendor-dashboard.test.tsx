...
const mockUseVendorStats = useVendorStats as jest.MockedFunction<any>;
const mockUseVendorGames = useVendorGames as jest.MockedFunction<any>;
const mockUseVendorRevenueChart =
  useVendorRevenueChart as jest.MockedFunction<any>;
const mockUseVendorParticipationChart =
  useVendorParticipationChart as jest.MockedFunction<any>;
...
describe('VendorDashboard', () => {
  ...
  describe('Loading State', () => {
    it('shows loading skeleton when data is loading', () => {
      ...
      expect(document.querySelectorAll('.bg-gray-200').length).toBeGreaterThan(
        0
      );
    });
  ...
  describe('Header Section', () => {
    ...
    it('displays subtitle text', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText("Here's what's happening with your games today.")
        ).toBeInTheDocument();
      });
    });
  ...
  describe('Recent Games Section', () => {
    ...
    it('displays empty state when no games exist', () => {
      ...
      expect(
        screen.getByText('Create your first game to start earning revenue.')
      ).toBeInTheDocument();
    });
  });
  ...
  describe('Quick Actions Section', () => {
    ...
    it('displays action icons', async () => {
      ...
      await waitFor(() => {
        ...
        expect(
          plusIcons.length + barChartIcons.length + settingsIcons.length
        ).toBeGreaterThan(0);
      });
    });
  });
