...
describe('VendorGames', () => {
    ...
    describe('Rendering', () => {
        ...
        it('displays create game button', () => {
            ...
            expect(createButton).toHaveAttribute('href', '/vendor-dashboard/create-game');
        });
    ...
    describe('Search and Filtering', () => {
        it('filters games by search term', () => {
            ...
            expect(screen.getByText('iPhone 15 Pro Max Giveaway')).toBeInTheDocument();
            expect(screen.queryByText('Nike Air Jordan Contest')).not.toBeInTheDocument();
    ...
    describe('Game Actions', () => {
        it('shows view button for all games', () => {
            ...
            expect(viewButtons[0]).toHaveAttribute('href', '/vendor-dashboard/games/game1');
        });
        ...
        it('shows edit button for draft games', () => {
            ...
            expect(editButtons[0]).toHaveAttribute('href', '/vendor-dashboard/games/game3/edit');
        });
        ...
        it('shows edit button for closed games', () => {
            ...
            expect(editButton).toHaveAttribute('href', '/vendor-dashboard/games/game1/edit');
        });
        ...
        it('does not show edit button for active games', () => {
            ...
            const activeGame = screen.getByText('iPhone 15 Pro Max Giveaway').closest('div');

            // Active game should not have edit button
            expect(activeGame).not.toContainElement(screen.queryByRole('link', { name: /edit/i }));
        });
    });
    ...
    describe('Pagination', () => {
        it('shows pagination when there are multiple pages', () => {
            ...
            expect(screen.getByText('Showing 1 to 12 of 25 games')).toBeInTheDocument();
        });
    ...
    describe('Responsive Design', () => {
        it('applies responsive grid classes', () => {
            ...
            const gamesGrid = document.querySelector('.grid.grid-cols-1.md\\:grid-cols-2.lg\\:grid-cols-3');
