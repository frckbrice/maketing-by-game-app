...
const AboutPage: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Hero Section */}
      <section
        className={`relative overflow-hidden ${isDark ? 'bg-gradient-to-r from-orange-500/20 to-red-500/20' : 'bg-gradient-to-r from-orange-100 to-red-100'}`}
      >
        <div
        ...
        <div className='relative container mx-auto px-4 py-20 sm:py-32'>
          <div className='text-center max-w-4xl mx-auto'>
            <AnimatedSection>
              <h1
                className={`text-4xl sm:text-6xl font-bold mb-6 leading-tight ${isDark ? 'text-white' : 'text-gray-900'}`}
              >
                {t('about.heroTitle')}
              </h1>
              <p
                className={`text-xl sm:text-2xl mb-8 leading-relaxed ${isDark ? 'text-orange-100' : 'text-orange-700'}`}
              >
                {t('about.heroSubtitle')}
              </p>
              <div
                className={`${isDark ? 'bg-white/10' : 'bg-orange-50'} backdrop-blur-sm rounded-2xl p-6 inline-block border ${isDark ? 'border-orange-500/30' : 'border-orange-200'}`}
              >
                <p
      ...
      <section className='py-20 container mx-auto px-4'>
        <div className='max-w-4xl mx-auto text-center'>
          <AnimatedSection>
            ...
            <p
              className={`text-lg mb-12 leading-relaxed ${isDark ? 'text-gray-300' : 'text-gray-600'}`}
            >
              {t('about.visionDesc')}
            </p>
          </AnimatedSection>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8 text-center'>
            <AnimatedSection delay={200} animation='fadeInLeft'>
              <div className='p-6'>
                <div
                  className={`w-16 h-16 ${isDark ? 'bg-orange-900/30' : 'bg-orange-100'} rounded-full flex items-center justify-center mx-auto mb-4 hover:scale-110 transition-transform duration-300`}
                >
                  <Users
          ...
          <div className='max-w-4xl mx-auto'>
              ...
              <AnimatedSection delay={200} animation='fadeInLeft'>
                <div className='flex flex-col md:flex-row items-center gap-8'>
                  <div className='flex-1'>
                    <div
                      className={`${isDark ? 'bg-gray-800' : 'bg-white'} p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300`}
                    >
            ...
            <AnimatedSection delay={800} animation='fadeIn'>
              <div className='mt-12 text-center'>
                <div
                  className={`inline-flex items-center gap-4 ${isDark ? 'bg-green-900/30' : 'bg-green-100'} px-8 py-4 rounded-2xl`}
                >
                  <Trophy
                  ...
                  <div className='text-left'>
                    <p
                      className={`font-bold ${isDark ? 'text-green-200' : 'text-green-800'}`}
                    >
                      {t('about.noOneEmpty')}
                    </p>
                    <p
          ...
          <div className='max-w-6xl mx-auto'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
              {values.map((value, index) => (
                ...
                >
                  <div
                    className={`${isDark ? 'bg-gray-800/50' : 'bg-white'} rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 h-full flex flex-col text-center ${isDark ? 'border border-gray-700/50' : 'border border-gray-200'}`}
                  >
                    <div
                      className={`w-16 h-16 ${isDark ? 'bg-orange-900/30 hover:bg-orange-800/40' : 'bg-orange-100 hover:bg-orange-200'} rounded-full flex items-center justify-center mx-auto mb-4 transition-colors duration-300`}
                    >
                      <value.icon
                        className={`w-8 h-8 ${isDark ? 'text-orange-400' : 'text-orange-600'}`}
                      />
                    ...
                    <p
                      className={`flex-1 text-sm leading-relaxed ${isDark ? 'text-gray-300' : 'text-gray-600'}`}
                    >
                      {value.description}
                    </p>
                  </div>
                ...
                <div>
                  ...
                  <div className='space-y-6'>
                    {merchantBenefits.map((benefit, index) => (
                      ...
                      >
                        <div
                          className={`flex items-start gap-4 ${isDark ? 'bg-gray-800' : 'bg-white'} p-6 rounded-xl shadow-sm hover:shadow-lg transition-shadow duration-300`}
                        >
                          <div
                            className={`w-12 h-12 ${isDark ? 'bg-blue-900/30' : 'bg-blue-100'} rounded-lg flex items-center justify-center flex-shrink-0`}
                          >
                            <benefit.icon
                  ...
                  <div className='space-y-6'>
                    {customerBenefits.map((benefit, index) => (
                      ...
                      >
                        ...
                        >
                          <div
                            className={`w-12 h-12 ${isDark ? 'bg-green-900/30' : 'bg-green-100'} rounded-lg flex items-center justify-center flex-shrink-0`}
                          >
                            <benefit.icon
        ...
        <div className='container mx-auto px-4'>
          <div className='max-w-4xl mx-auto'>
            ...
            <AnimatedSection delay={200} animation='fadeIn'>
              <div
                className={`${isDark ? 'bg-red-900/20 border-red-800' : 'bg-red-50 border-red-200'} border rounded-2xl p-8`}
              >
                <p
                  className={`text-lg mb-6 text-center ${isDark ? 'text-gray-300' : 'text-gray-700'}`}
                >
                  ...
                  {[
                    ...
                    >
                      <div className='text-center'>
                        <div
                          className={`w-12 h-12 ${isDark ? 'bg-red-900/30' : 'bg-red-100'} rounded-full flex items-center justify-center mx-auto mb-3`}
                        >
                          <span
                            className={`font-bold text-xl ${isDark ? 'text-red-400' : 'text-red-600'}`}
                          >
                            ❌
                          </span>
                        </div>
      ...
      {/* Commitment */}
      <section
        className={`py-20 ${isDark ? 'bg-gradient-to-r from-orange-600/30 to-red-500/30' : 'bg-gradient-to-r from-orange-100 to-red-100'}`}
      >
        <div className='container mx-auto px-4'>
          <div className='max-w-4xl mx-auto text-center'>
            <AnimatedSection>
            ...
            <AnimatedSection delay={200} animation='fadeInUp'>
              <p
                className={`text-xl mb-8 leading-relaxed ${isDark ? 'text-orange-100' : 'text-orange-700'}`}
              >
            ...
            <AnimatedSection delay={400} animation='fadeInUp'>
              <p
                className={`text-lg mb-8 ${isDark ? 'text-orange-100' : 'text-orange-700'}`}
              >
                {t('about.missionDesc')}
              </p>
            </AnimatedSection>
      ...
      {/* Campaign Text */}
      <section
        className={`py-16 ${isDark ? 'bg-gradient-to-br from-yellow-900/20 to-orange-900/20' : 'bg-gradient-to-br from-yellow-50 to-orange-50'}`}
      >
        <div className='container mx-auto px-4'>
          <div className='max-w-4xl mx-auto'>
            <AnimatedSection animation='fadeIn'>
              <div
                className={`${isDark ? 'bg-gray-800 border-orange-800' : 'bg-white border-orange-200'} rounded-2xl shadow-lg p-8 border-2`}
              >
                <AnimatedSection delay={200} animation='fadeInUp'>
                  <h3
                ...
                <AnimatedSection delay={400} animation='fadeInUp'>
                  <div
                    className={`${isDark ? 'bg-gradient-to-r from-orange-900/30 to-yellow-900/30' : 'bg-gradient-to-r from-orange-100 to-yellow-100'} p-6 rounded-xl`}
                  >
                    <div className='space-y-4'>
                      {[
                        ...
                        >
                          {item.emoji ? (
                            <p
                              className={`flex items-center gap-2 ${isDark ? 'text-gray-200' : 'text-gray-800'}`}
                            >
