...
describe('LocaleSwitcher', () => {
    ...
    describe('Main LocaleSwitcher', () => {
        ...
        it('shows chevron down icon', () => {
            ...
            const chevronIcon = document.querySelector('svg[class*="lucide-chevron-down"]');
        ...
        it('highlights current locale as active', () => {
            ...
            expect(activeLocale).toHaveClass('bg-orange-700', 'text-white', 'dark:bg-orange-600');
        });
    ...
    describe('Edge Cases', () => {
        it('handles unsupported locales gracefully', () => {
            ...
            Object.defineProperty(require('react-i18next'), 'useTranslation', {
                value: () => ({
                    i18n: { language: 'de' },
                }),
                writable: true,
