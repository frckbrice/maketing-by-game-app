...
describe('NotificationPermission', () => {
  ...
  it('renders enabled state when FCM token exists', () => {
    ...
    expect(
      screen.getByText('You will receive notifications')
    ).toBeInTheDocument();
    expect(
      screen.getByText('Push notifications are active')
    ).toBeInTheDocument();
  ...
  it('renders default state when no token and no error', () => {
    ...
    expect(
      screen.getByText('Push notifications for real-time updates')
    ).toBeInTheDocument();
    expect(
      screen.getByText('Email notifications for summaries')
    ).toBeInTheDocument();
    expect(
      screen.getByText('Personalized content recommendations')
    ).toBeInTheDocument();
    expect(
