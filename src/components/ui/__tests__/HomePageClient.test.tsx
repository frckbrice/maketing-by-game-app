...
describe('HomePageClient', () => {
    ...
    describe('Responsive Design', () => {
        ...
        it('applies responsive spacing classes', () => {
            ...
            const banner = screen.getByRole('banner');
            const spacingContainer = banner.querySelector('.space-y-1.sm\\:space-y-0');
    ...
    describe('Styling and Layout', () => {
        ...
        it('applies correct alignment classes', () => {
            ...
            const banner = screen.getByRole('banner');
            const alignContainer = banner.querySelector('.items-center.justify-center');
    ...
    describe('Component Structure', () => {
        it('renders in correct order', () => {
            ...
            const homeComponent = container?.querySelector('[data-testid="home-page-component"]');
