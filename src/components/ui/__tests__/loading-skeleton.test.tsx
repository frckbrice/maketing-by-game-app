...
describe('LoadingSkeleton', () => {
  ...
  it('has correct search and filter layout for table', () => {
    ...
    const searchFilterContainer = screen
      .getAllByTestId('skeleton')[0]
      .closest('div')?.parentElement;
    expect(searchFilterContainer).toHaveClass(
      'flex',
      'justify-between',
      'items-center'
    );
