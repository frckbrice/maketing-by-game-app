...
describe('FeatureCard', () => {
  ...
  it('handles different icon components', () => {
    const { Heart } = jest.requireActual('lucide-react');
  ...
  it('handles long title and description', () => {
    const longProps = {
      ...
      description:
        'This is a very long description that contains a lot of text and might also wrap to multiple lines in the UI',
    };
