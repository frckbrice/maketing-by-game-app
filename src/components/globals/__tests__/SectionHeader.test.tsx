...
describe('SectionHeader', () => {
  ...
  it('handles long title and subtitle', () => {
    const longTitle =
      'This is a very long section title that might wrap to multiple lines in the UI';
    const longSubtitle =
      'This is a very long subtitle that contains a lot of text and might also wrap to multiple lines in the UI';
