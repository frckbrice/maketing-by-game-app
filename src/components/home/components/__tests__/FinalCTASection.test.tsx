...
describe('FinalCTASection', () => {
    it('renders with light theme', () => {
        ...
        expect(screen.getByText('Start playing today and win amazing prizes')).toBeInTheDocument();
    });
    ...
    it('renders primary button correctly', () => {
        ...
        expect(primaryButton.closest('button')).toHaveClass('px-12', 'py-4', 'text-xl', 'font-bold');
    });
    ...
    it('renders secondary button correctly', () => {
        ...
        expect(secondaryButton.closest('button')).toHaveAttribute('data-variant', 'outline');
    });
    ...
    it('applies light theme styling correctly', () => {
        ...
        expect(section).toHaveClass('bg-gradient-to-r', 'from-gray-100', 'via-white', 'to-gray-100');
    });
    ...
    it('applies dark theme styling correctly', () => {
        ...
        const section = screen.getByText('Ready to Win?').closest('section');
        expect(section).toHaveClass('bg-gradient-to-r', 'from-black', 'via-gray-900', 'to-black');
    });
    ...
    it('has correct badge styling for light theme', () => {
        ...
        expect(badge).toHaveClass('border-orange-300/50', 'text-orange-600', 'bg-orange-100/30');
    });
    ...
    it('has correct badge styling for dark theme', () => {
        ...
        const badge = screen.getByText('Ready to Win?');
        expect(badge).toHaveClass('border-orange-500/30', 'text-orange-400', 'bg-orange-500/5');
    });
    ...
    it('has correct title styling for light theme', () => {
        ...
        expect(title).toHaveClass('text-4xl', 'lg:text-5xl', 'font-bold', 'mb-6', 'text-gray-900');
    });
    ...
    it('has correct title styling for dark theme', () => {
        ...
        const title = screen.getByText('Join the Lottery Revolution');
        expect(title).toHaveClass('text-4xl', 'lg:text-5xl', 'font-bold', 'mb-6', 'text-white');
    });

    it('has correct subtitle styling for light theme', () => {
        render(<FinalCTASection isDark={false} />);

        const subtitle = screen.getByText('Start playing today and win amazing prizes');
        expect(subtitle).toHaveClass('text-xl', 'mb-8', 'max-w-2xl', 'mx-auto', 'text-gray-600');
    });
    ...
    it('has correct subtitle styling for dark theme', () => {
        ...
        const subtitle = screen.getByText('Start playing today and win amazing prizes');
        expect(subtitle).toHaveClass('text-xl', 'mb-8', 'max-w-2xl', 'mx-auto', 'text-gray-300');
    });

    it('has correct button container styling', () => {
        render(<FinalCTASection isDark={false} />);

        const buttonContainer = document.querySelector('.flex.flex-col.sm\\:flex-row.gap-4.justify-center.items-center.mb-12');
        expect(buttonContainer).toHaveClass('flex', 'flex-col', 'sm:flex-row', 'gap-4', 'justify-center', 'items-center', 'mb-12');
    });

    it('has correct trust indicators container styling', () => {
        render(<FinalCTASection isDark={false} />);

        const trustContainer = screen.getByText('10,000+ Products Won').closest('div')?.parentElement;
        expect(trustContainer).toHaveClass('flex', 'justify-center', 'items-center', 'gap-8', 'flex-wrap');
    });
    ...
    it('has responsive design classes', () => {
        ...
        const container = document.querySelector('.max-w-4xl.mx-auto.text-center.px-4.lg\\:px-8');
        expect(container).toHaveClass('max-w-4xl', 'mx-auto', 'text-center', 'px-4', 'lg:px-8');
    });
